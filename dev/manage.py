...
#### USE OF Flask CLI instead of Flask Script (deprecated)
...
# app = create_app(config_file='./configs/munimap.conf')
...
# @cli_manager.command()
# @click.option('-t/--test', default=False, help='This is a test')
# def test(coverage):
#   print("Hello world")
# # manager.add_option('-c', '--config', dest='config_file', required=False)
# # cli_manager.add_command("runserver", Server(
# #     host='0.0.0.0',
# #     threaded=True,
# #     # extra_files=['munimap_develop.conf', 'data/layers_conf.yaml']
# # ))
