angular.module("schemaForm").run(["$templateCache", function($templateCache) {$templateCache.put("directives/decorators/bootstrap/colorpicker/colorpicker.html","<div class=\"form-group {{ form.htmlClass }}\" ng-class=\"{\'has-error\': hasError()}\">\n  <label class=\"control-label\" ng-show=\"showTitle()\">{{form.title}}</label>\n<input name=\"{{ form.key[0] }}\" class=\"hidden\" sf-field-model ng-model=\"model[form.key]\" type=\"text\">\n  <div ng-init=\"defaultSpectrumOptions = {\n                  showInput: true,\n                  showAlpha: true,\n                  allowEmpty: true,\n                  showPalette: true,\n                  preferredFormat: form.colorFormat || \'rgb\',\n                  palette: [[\'#fce94f\', \'#fcaf3e\', \'#e9b96e\'],\n                  [\'#8ae234\', \'#729fcf\', \'#ad7fa8\'],\n                  [\'#ef2929\', \'#888a85\', \'#deface\']]\n                }\">\n    <spectrum-colorpicker\n      ng-model=\"$$value$$\"\n      format=\"form.colorFormat || \'rgb\'\"\n      style=\"background-color: white\"\n      type=\"color\"\n      schema-validate=\"form\"\n      options=\"form.spectrumOptions || defaultSpectrumOptions\"></spectrum-colorpicker>\n</div>\n  <span class=\"help-block\">{{ (hasError() && errorMessage(schemaError())) || form.description}}</span>\n</div>\n");}]);
